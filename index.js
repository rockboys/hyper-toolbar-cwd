...
exports.decorateHyperToolbar = (HyperToolbar, { React }) => {
  ...
  class HyperToolbarCwd extends React.Component {
    ...
    render () {
      return React.createElement('div', { className: 'hyper-cwd-container', onMouseDown: this.onMouseDownHandler },
        ...
        React.createElement('a', { className: 'path-name' }, `${this.props.cwd}`)
      );
    }
  }
